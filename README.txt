IMPORTANT
To launch the leaderboard bot, you must first replace the values 'your discord token' (main.py, last line) with the token of your own Discord bot. Then, you need to replace the value #your guild id here with your guild ID (main.py, line 12) and the value channel_id (line 85).
